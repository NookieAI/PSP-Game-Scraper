<div align="center">
<img width="960" alt="PSP Game Browser — library view" src=".github/screenshots/library.png" />

# 🎮 PSP Game Browser

**Browse, search, and download from a huge PSP game library — all from one clean desktop app.**

[![Latest Release](https://img.shields.io/github/v/release/NookieAI/PSP-Game-Scraper?label=latest&color=8e5dd5&style=for-the-badge)](https://github.com/NookieAI/PSP-Game-Scraper/releases/latest)
[![Downloads](https://img.shields.io/github/downloads/NookieAI/PSP-Game-Scraper/total?color=8e5dd5&style=for-the-badge)](https://github.com/NookieAI/PSP-Game-Scraper/releases)
[![Platforms](https://img.shields.io/badge/platforms-Windows%20%7C%20macOS%20%7C%20Linux-8e5dd5?style=for-the-badge)](#-install)
...
Grab the right file for your computer from the **[Latest Release](https://github.com/NookieAI/PSP-Game-Scraper/releases/latest)** page:

| Your computer | Download |
|---|---|
| 🪟 **Windows 10/11** | `PSP Game Browser v*.exe` — *portable, just double-click* |
| 🍎 **Mac (Apple Silicon — M1/M2/M3/M4)** | `PSP Game Browser v*_aarch64.app.zip` |
| 🍎 **Mac (Intel)** | `PSP Game Browser v*_x64.app.zip` |
| 🐧 **Linux (any)** | `PSP Game Browser v*_amd64.AppImage` — *portable, just chmod +x* |
...
1. Download `PSP Game Browser v*.exe` from the [releases page](https://github.com/NookieAI/PSP-Game-Scraper/releases/latest).
...
2. Double-click the `.zip` to unzip — you'll get **PSP Game Browser.app**.
3. Put it anywhere you want — Applications, Desktop, an external drive. Then double-click to open.
4. The first time you open it: macOS will refuse and say *"PSP Game Browser can't be opened because Apple cannot check it for malicious software."* This is normal for apps not sold through the App Store.
...
1. Download `PSP Game Browser v*_amd64.AppImage`.
2. Right-click it → Properties → make it executable.  
   *(Or in a terminal: `chmod +x "PSP Game Browser"*.AppImage`)*
...
- If nothing happens after an update starts, your antivirus may be blocking it. Temporarily disable it and try again, or download manually from the [releases page](https://github.com/NookieAI/PSP-Game-Scraper/releases/latest).
</details>
...
- **Mac:** drag PSP Game Browser.app to the Trash.
- **Linux:** delete the .AppImage file.

If you want to clear remembered settings too: delete the small config folder the app stores in your user data folder (`%APPDATA%\com.nookie.pspbrowser\` on Windows, `~/Library/Application Support/com.nookie.pspbrowser/` on Mac, `~/.local/share/com.nookie.pspbrowser/` on Linux).
</details>
...
Open an [Issue](https://github.com/NookieAI/PSP-Game-Scraper/issues) and describe what happened. Screenshots help a lot.
